$(document).ready(function() {
    ...
    $(".choice-desc-3").draggable({revert: "invalid",
        start: function(event, ui) {
            choicedrgcount = choicedrgcount + 1;
        },
        stop: function(event, ui) {
    ...
    $(".choice-head-3").droppable({
        accept: ".choice-desc-3",
        hoverClass: "ui-state-hover",
        drop: function(event, ui) {
            $(this).parent().addClass("answer-found");
            $(".choice-desc-3").position({
                my: "right center",
                at: "right center",
                of: ".choice-head-3"
            });
    ...
    function choicedrgcountfunction() {
        if (choicedrgcount == 3 || choicedrgcount == 4) {
            var totallength2 = $(".your-choice-game").children(".answer-found").length;
            if (totallength2 == 3) {
//                alert("Well Done \n\ Read More..");
//                window.location.href = '#disclosures-1';
        ...
        if (choicedrgcount == 5) {
//            alert("Sorry.Please have a Quick look through your rights and play again.");
//            window.location.href = '#your-choice';
